...
@section('title', 'Home')
<!-- Home удален потуму что он остался в main шаблоне-->
@section('content')
                    ...
                    <div class="product">
                        ...
                        <div class="product_content">
                            <div class="product_title"><a
                                    href="{{route('showProduct', ['category', $product->id])}}">{{$product->title}}</a>
                            </div>

                            @if($product->new_price != null)
                            <div style="text-decoration: line-through; color: #dc3545">$ {{$product->price}}</div>
                ...
                <div class="newsletter_content text-center">
                    ...
                    <div class="newsletter_text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                            a ultricies metus. Sed nec molestie eros</p>
                    </div>
