                    ...
                    <div class="details_image">
                        ...
                        @php
                            ...
                            if (count($item->images) > 0){
                                $image = $item->images[0]['img']; //если картинки есть то берем первую и виводим в большую миниату.
                            }else {
                                $image= 'No-image.png';
                            }
                          //dd($product->images[0]['img']);
                        ...
                        <div
                            ...
                            @else
                                @foreach($item->images as $img)
                                    @if($loop->first)
                                        <div class="details_image_thumbnail active" data-image="/images/{{$img['img']}}"><img
                                                src="/images/{{$img['img']}}" alt="{{$item->title}}"></div>
                                    @else
                                        <div class="details_image_thumbnail" data-image="/images/{{$img['img']}}"><img
                                                src="/images/{{$img['img']}}" alt="{{$item->title}}"></div>
                                    @endif
...
@endsection
<!-- Footer удален потому что он есть main шаблоне -->
